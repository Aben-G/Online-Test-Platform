      ...
      <div className="gradient-hero text-primary-foreground py-6 px-4">
        <div className="container mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-medium opacity-80">Hi, {studentName}</span>
          </div>
          <h1 className="text-3xl font-display font-bold">Choose a Subject</h1>
          <p className="opacity-80 mt-1">Select a subject to view available tests</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {subjects.length === 0 ? (
          <div className="text-center py-20 animate-fade-in">
            ...
            <h2 className="text-xl font-display font-semibold text-foreground mb-2">No Subjects Yet</h2>
            <p className="text-muted-foreground">The admin hasn't created any subjects yet. Check back later!</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-slide-up">
            {subjects.map((subject) => (
              <button
                ...
                className="bg-card rounded-2xl shadow-card hover:shadow-card-hover transition-all duration-300 p-6 text-left group hover:-translate-y-1"
              >
                ...
                <h3 className="text-lg font-display font-semibold text-foreground mb-1">{subject.name}</h3>
